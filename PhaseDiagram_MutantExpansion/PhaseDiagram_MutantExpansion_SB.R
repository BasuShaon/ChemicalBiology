...
{
  # set the wd to folder containing Runx2, Hoxa13, and Hoxd13 subfolders
  setwd(paste('https://github.com/BasuShaon/ChemicalBiology/tree/master/PhaseDiagram_MutantExpansion/',gene,sep=""))
  require(ggplot2)
...
#Use this function to generate mutant phase diagrams for Hoxd13, Hoxa13, and Runx2.
Boss <- function(gene)
#Input options are either 'Hoxd13', 'Hoxa13', or 'Runx2'. 
{
  y <- MasterTable(gene)
