#setwd to subfolder containing "Hoxd13_PhaseDiagram_summary" and "objectsRED" file
#both available on github
setwd('https://github.com/BasuShaon/ChemicalBiology/tree/master/DualFlouresencePlot_ClientTitration')

install.packages(directlabels)
require(ggplot2)
require(directlabels)

#make phase diagram inset --------------------------------------------------------------
...
#making Dual Fluorescence Plot (DFP)-------------------------------------------------------------------
...
#make Titration DFP Series and flush phase diagram insets ---------------------------
